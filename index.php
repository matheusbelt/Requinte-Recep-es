...
<body>
	...
	<div class="container-fluid menu-background">
		<nav class="container menu">
			...
			<div class="container">
				<button class="navbar-toggle" data-toggle="collapse" data-target=".navHeader" id="menu-hamburguer">
				...
				<div class="collapse navbar-collapse navHeader">
					<ul class="menu-inicial nav nabar-nav">
						<a href="#oqbitweek"><li>Eventos</li></a>
						<a href="#teremos"><li>Depoimentos</li></a>
						<a href="#footer"><li>Catálogo</li></a>
		...
		<div class="container">
			...
			<article class="casamento">
				...
				<div class="col-md-6 texto-right casamento">
					...
					<p class="eventos-corpo-texto casamento-corpo-texto">Texto do casamento</p>
			...
			<article class="formatura">
				...
				<div class="col-md-6 texto-right formatura">
	...
	<section class="30anos-requinte container-fluid" id="30anos-requinte">
		<div class="container 30anos-corpo">
			<h1 class="30anos-titulo">30 Anos Requinte Recepções</h1>
	...
	<section class="catalogos container-fluid">
		<div class="container catalogos-corpo">
			<h1 class="catalogos-titulo">Catálogos</h1>
	...
	<footer class="contato container-fluid">
